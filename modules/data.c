...
const int drone_speed_values[DRONE_LEVEL_COUNT] = {10, 15, 20, 30};            /* 无人机不同等级的速度 */
...
/* 地块基础产量与损伤模型参数 */
const int field_base_output = 10;                    /* 基础产量 */
...
const int field_damage_probability_multiplier = 100; /* 概率乘数 */
