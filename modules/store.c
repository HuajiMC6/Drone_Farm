...
//field update
int field_output_update_price[3]={2500,5000,10000};
int field_ready_time_update_price[3]={2500,5000,10000};
int field_tolerance_update_price[3]={10000,20000,50000};